...
using FoodDelivery.Modules.Orders.Shared.Extensions.ApplicationBuilderExtensions;
using FoodDelivery.Modules.Orders.Shared.Extensions.ServiceCollectionExtensions;

namespace FoodDelivery.Modules.Orders;
