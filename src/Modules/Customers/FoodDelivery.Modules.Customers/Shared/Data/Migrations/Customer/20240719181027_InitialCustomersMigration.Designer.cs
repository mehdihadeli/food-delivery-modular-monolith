...
namespace FoodDelivery.Modules.Customers.Shared.Data.Migrations.Customer
{
    ...
    [Migration("20240719181027_InitialCustomersMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Customers.Customers.Models.Customer", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Customers.RestockSubscriptions.Models.Write.RestockSubscription", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Customers.Customers.Models.Customer", b =>
                {
                    ...
                    b.OwnsOne("FoodDelivery.Modules.Customers.Customers.Models.CustomerName", "Name", b1 =>
                        {
                            b1.Property<long>("CustomerId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Customers.RestockSubscriptions.Models.Write.RestockSubscription", b =>
                {
                    b.HasOne("FoodDelivery.Modules.Customers.Customers.Models.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                    ...
                    b.OwnsOne("FoodDelivery.Modules.Customers.RestockSubscriptions.ValueObjects.ProductInformation", "ProductInformation", b1 =>
                        {
