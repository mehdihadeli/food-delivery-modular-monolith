using ECommerce.Modules.Customers.Products.Features.CreatingProduct.Events.External;
using ECommerce.Modules.Customers.Products.Features.ReplenishingProductStock.Events.External;
using ECommerce.Modules.Shared.Catalogs.Products.Events.Integration;
using Humanizer;
using MassTransit;
using RabbitMQ.Client;

namespace ECommerce.Modules.Customers.Products;
