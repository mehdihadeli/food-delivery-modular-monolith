...
public static class IdentityServerConfig
{
    ...
    public static IEnumerable<ApiScope> ApiScopes =>
        new List<ApiScope> { new("food-delivery-api", "FoodDelivery.Modules.Catalogs API") };

    public static IList<ApiResource> ApiResources =>
        new List<ApiResource>
        {
            new ApiResource("FoodDeliveryApiResource", "FoodDelivery.Modules.Catalogs API Resource")
            {
