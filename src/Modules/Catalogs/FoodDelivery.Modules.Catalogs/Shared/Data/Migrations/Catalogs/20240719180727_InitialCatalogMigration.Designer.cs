...
namespace FoodDelivery.Modules.Catalogs.Shared.Data.Migrations.Catalogs
{
    ...
    [Migration("20240719180727_InitialCatalogMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Catalogs.Brands.Brand", b =>
                {
                    b.Property<long>("Id")
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Catalogs.Categories.Category", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Catalogs.Products.Models.Product", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Catalogs.Products.Models.ProductImage", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Catalogs.Products.Models.ProductView", b =>
                {
                    b.Property<long>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Catalogs.Suppliers.Supplier", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Catalogs.Products.Models.Product", b =>
                {
                    b.HasOne("FoodDelivery.Modules.Catalogs.Brands.Brand", "Brand")
                        .WithMany()
                    ...
                    b.HasOne("FoodDelivery.Modules.Catalogs.Categories.Category", "Category")
                        .WithMany()
                    ...
                    b.HasOne("FoodDelivery.Modules.Catalogs.Suppliers.Supplier", "Supplier")
                        .WithMany()
                    ...
                    b.OwnsOne("FoodDelivery.Modules.Catalogs.Products.ValueObjects.Dimensions", "Dimensions", b1 =>
                        {
                    ...
                    b.OwnsOne("FoodDelivery.Modules.Catalogs.Products.ValueObjects.Stock", "Stock", b1 =>
                        {
                            b1.Property<long>("ProductId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("FoodDelivery.Modules.Catalogs.Products.Models.ProductImage", b =>
                {
                    b.HasOne("FoodDelivery.Modules.Catalogs.Products.Models.Product", "Product")
                        .WithMany("Images")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
