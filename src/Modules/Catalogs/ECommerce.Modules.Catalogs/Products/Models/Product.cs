...
using ECommerce.Modules.Catalogs.Products.Features.ChangingMaxThreshold;
using ECommerce.Modules.Catalogs.Products.Features.ChangingProductBrand.Events.Domain;
using ECommerce.Modules.Catalogs.Products.Features.ChangingProductCategory.Events;
using ECommerce.Modules.Catalogs.Products.Features.ChangingProductPrice;
using ECommerce.Modules.Catalogs.Products.Features.ChangingProductSupplier.Events;
using ECommerce.Modules.Catalogs.Products.Features.ChangingRestockThreshold;
...
namespace ECommerce.Modules.Catalogs.Products.Models;
